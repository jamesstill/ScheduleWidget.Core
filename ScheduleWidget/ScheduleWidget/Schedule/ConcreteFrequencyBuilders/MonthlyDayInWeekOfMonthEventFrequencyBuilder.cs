...
{
    public class MonthlyDayInWeekOfMonthEventFrequencyBuilder : IEventFrequencyBuilder
    {
        public TemporalExpressionUnion Create(ISchedule schedule)
        {
            ...
            foreach (var weeklyInterval in weeklyIntervals)
            {
                ...
                {
                    var dayInMonth = new ScheduleDayInWeekOfMonth((DayInterval)dayOfWeek, (WeekInterval)weeklyInterval);
