...
{
    /// <summary>
    /// An annual temporal expression is a day that commemorates or 
    ...
    /// </summary>
    public class ScheduleAnnual : TemporalExpression
    {
        ...
        /// var birthday = new ScheduleAnnual(8, 1);
        /// </summary>
        /// <param name="month"></param>
        /// <param name="day"></param>
        public ScheduleAnnual(int month, int day) 
        {
            _month = month;
            _day = day;
        }
