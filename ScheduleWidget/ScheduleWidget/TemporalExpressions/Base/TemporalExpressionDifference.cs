...
{
    public class TemporalExpressionDifference : TemporalExpression
    {
        private readonly TemporalExpression _inclusiveExpression;
        private readonly TemporalExpression _exclusiveExpression;

        public TemporalExpressionDifference(TemporalExpression inclusiveExpression, TemporalExpression exclusiveExpression)
        {
